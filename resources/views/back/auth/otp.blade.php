											...
											<div class="card-sigin">
												<div class="main-signup-header">
                                                    ...
                                                    <form action="{{ route('verify.otp') }}" method="POST">
                                                        ...
                                                        <button class="btn btn-main-primary btn-block" type="submit">{{__('route.verification')}}</button>
													</form>
                                                    ...
                                                    <form action="{{ route('create.Otp') }}" method="POST">
                                                        ...
                                                        <button type="submit" class="btn btn-main-primary btn-block my-3">{{ __('route.resend otp') }}</button>
                                                    </form>
